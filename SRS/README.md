...
Графический интерфейс проекта представлен с помощью мокапов [главного окна](https://github.com/Timah531h/Tritpo/blob/main/SRS/MainWindow.png)  и [способа регулирования громкости](https://github.com/Timah531h/Tritpo/blob/main/SRS/ShowVolume.png).
